"""Canonical component.read models."""

from typing import TYPE_CHECKING, Literal, TypeAlias

if TYPE_CHECKING:
    from ..models import Channel, GuildMember, Role, User
...
_SelectDefaultValueType: TypeAlias = Literal["user", "role", "channel"]
